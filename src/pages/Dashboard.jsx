      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-top">
          ...
          <div className="sidebar-brand">
            <div className="brand-icon-sm">SR</div>
            <span className="brand-text">ScreenerAI</span>
          </div>
        ...
        <header className="dash-header">
          ...
          <div className="header-left">
            ...
            <h1 className="page-title">
              ...
              {active === "screen" && "Resume Screening"}
              {active === "history" && "Screening History"}
        ...
        <div className="dash-content">
            ...
            <div className="screen-layout">
              ...
              <div className="top-section">
                ...
                <div className="upload-area">
                  <UploadPanel onResults={setResults} />
                </div>

                <div className="ai-area">
                  <IntelligencePanel results={results} />
                </div>
          ...
          {active === "settings" && (
            ...
            <div className="placeholder-panel">
              ...
              <p>
                Configure your screening preferences and API connections.
              </p>
